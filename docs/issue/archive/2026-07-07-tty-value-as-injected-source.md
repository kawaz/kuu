...
pending_entered:
discarded_entered:
resolved_entered: 2026-07-12T18:30:51+09:00
discard_reason:
pending_reason:
close_reason: ["dr/DR-098","fixture: fixtures/value-sources/tty-ladder.json + fixtures/definition-error/tty-non-bool.json 新規、corpus/real-cli/die.json 追随","spec: DESIGN §11.4/§12b/§13/§13.9/§16, schema/wire.schema.json, schema/fixture.schema.json, docs/CONFORMANCE.md 追随","受け入れ条件外: kuu.mbt 側 tty_provider/tty installer/definition-error 検査の実装 (本issueはモデル化検討・純粋性明示・DR記録・corpus fixture 用意の4条件のみ)","実機検証: KUU_FIXTURES 注入で新規2 fixture は kuu.mbt 側 skip ledger により UNEXPECTED SKIP (option has unsupported key 'tty')","kuu.mbt 実装は未実施、後続 issue 2026-07-12-dr-098-implementation で追跡"]
blocked_by:
