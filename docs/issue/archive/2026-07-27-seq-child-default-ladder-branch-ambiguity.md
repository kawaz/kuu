...
CHILDDEF-Q1=b の fixture 反映時、実装 worker (impl-two-rulings) の指摘で `fixtures/or-parse/unselected-branch-default-null.json` の定義がこの断面に該当することが判明した。
...
- fixtures/or-parse/unselected-branch-default-null.json (型排他化で回避した実例)
