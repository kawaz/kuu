...
blocked_entered:
pending_entered:
discarded_entered: 2026-07-11T10:06:10+09:00
resolved_entered:
discard_reason: ["discarded: kawaz裁定(2026-07-11)で不採用確定 — flag/count presetの正当化根拠(shortがvariant DSLを持たない逃げ道問題)がboolには無く、\"no:set:false\"の明示1行で足りる。DR-011「noの意味はまちまち・常に明示書き」の精神をpresetで固定化する動機が薄い。"]
pending_reason:
close_reason: ["discarded: kawaz裁定(2026-07-11)で不採用確定、DR-011裁定を維持"]
blocked_by:
origin: 自リポ TODO
---
