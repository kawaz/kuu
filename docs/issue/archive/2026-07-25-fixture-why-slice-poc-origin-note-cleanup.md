...
pending_entered:
discarded_entered:
resolved_entered: 2026-07-25T23:04:46+09:00
discard_reason:
pending_reason:
close_reason: ["done:53 fixture / 55 箇所を一括処理 (jj commit d8e87e88 前)","done:方針=蒸留元/slice PoC/phaseNN/第N弾の由来注記クラスを全削除、DR-NNN/DESIGN §N.N の仕様引用は保持","done:lowering/*/basic.json の『参照実装プロトタイプ断面実測』(DR-070 §1b) と value-sources/inherit-ladder.json の RUNNER GAP はテスト番号を持たない実装挙動記述のため対象外として保持","pending:KTop/Held/Pending の正典化裁定は別 issue のスコープ (未着手)"]
blocked_by:
origin: 自リポ TODO
---
