...
pending_entered:
discarded_entered:
resolved_entered: 2026-07-31T01:07:49+09:00
discard_reason:
pending_reason:
close_reason: ["fixture:fixtures/constraints-parse/requires-bool-target-default-fn-borrow.json","done:3 case (borrow-true-satisfies-requires/borrow-false-still-violates/borrow-absent-source-violates)","done:commit c66e646a","done:expectations from DR-047 §5 + DR-113 §5.4 + DESIGN §11.4","done:kuu.mbt conformance mismatch 0 confirmed fresh 2026-07-31 decoded=389"]
blocked_by:
