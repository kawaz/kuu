...
pending_entered:
discarded_entered:
resolved_entered: 2026-07-27T12:44:21+09:00
discard_reason:
pending_reason:
close_reason: ["done:CHILDDEF-Q1=b の再導出で該当 case (named-group-child-default の partial-row) が success へ更新され、errors 欠落の schema 違反自体が消滅 (default 持ち子は空席のまま完全経路、DR-088 の子位置一般化)。schema required の緩和も fixture への errors 追記も不要"]
blocked_by:
origin: 自リポ TODO
---
