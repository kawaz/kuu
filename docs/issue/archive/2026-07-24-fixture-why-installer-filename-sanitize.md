...
pending_entered:
discarded_entered:
resolved_entered: 2026-07-25T22:43:17+09:00
discard_reason:
pending_reason:
close_reason: ["done:commit 0d04469b で完了、43 ファイル/75 箇所書き換え、fixtures 配下の .mbt 参照は 0 件","done:why のみ変更、definition/args/expect/installers は無変更を機械確認 (why を除去した構造が全 43 ファイルで一致)","done:全 328 fixture が JSON valid、lint-descriptors/lint-reference とも OK","done:保持語は正典文書の語彙判定 — DR-042 canonical installer 名 (long/short/dd/command/global/env/config/inherit/inheritable/multiple/constraint/flag)、AtomicAST、#cons (LOWERING §B.8, DR-046 §4, DR-063 §3)、@depr: (DR-058/DR-110)、unwrap_single/eq_split/parse_number、ParserContext (DR-053)、Accept (LOWERING §0)","後続 issue 2 件に分離: slice PoC 由来注記の一括処理 / DR 本体に残る実装固有名"]
blocked_by:
origin: 自リポ TODO
---
