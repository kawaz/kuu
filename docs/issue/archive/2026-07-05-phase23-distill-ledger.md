...
pending_entered:
discarded_entered:
resolved_entered: 2026-07-08T22:00:58+09:00
discard_reason:
pending_reason:
close_reason: ["15 領域 D1〜D15 の parse fixture 蒸留を全て完了 (fixtures/ の 15 サブディレクトリに計 91 fixture 相当)","§4 要確認事項 3 件 (sources 拡張 / failure-actions 候補 def 軸 / warnings フィールド) は CONFORMANCE §2/§3 + DR-069/053/073 で全解消","残る「slice 167 テスト → fixture case の 1:1 網羅性検算」は distill-1to1-coverage-audit へ切り出し"]
blocked_by:
