...
| 2026-07-10 | design | open | [list-merge-piece-op-vocabulary](./2026-07-10-list-merge-piece-op-vocabulary.md) | リスト merge — piece レベル op 語彙 (add/remove/splice) とラダー合成 |
| 2026-07-10 | design | open | [multiple-declared-default-semantics](./2026-07-10-multiple-declared-default-semantics.md) | multiple 要素への宣言 default (配列) の意味論が未規定 |
| 2026-07-10 | design | open | [definition-error-fixture-format](./2026-07-10-definition-error-fixture-format.md) | definition_error fixture format の確定 (DR-065 予約分の初実例化) + accum×update の kind 判定 |
| 2026-07-10 | design | open | [default-op-source-tag-contradiction](./2026-07-10-default-op-source-tag-contradiction.md) | op=default の sources タグ — DR-031 明文 (cli) と fixture 実践 (default) の矛盾 |
