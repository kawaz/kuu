...
| 2026-07-25 | bug | open | [expose-key-collision-option-command-silent-loss](./2026-07-25-expose-key-collision-option-command-silent-loss.md) | 露出キー衝突検出が option × command で効かず command が値を silent に上書きする (DR-073) |
