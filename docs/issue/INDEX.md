...
| 2026-07-23 | design | open | [completion-script-multi-entry-tiebreak-undecided](./2026-07-23-completion-script-multi-entry-tiebreak-undecided.md) | completion_script 複数入口の同時発火時の内部セル勝者順が未裁定 (DR-117 実装レビュー由来) |
| 2026-07-23 | design | open | [completion-query-duplicate-candidates](./2026-07-23-completion-query-duplicate-candidates.md) | completion_query が同一 insert の候補を通常版/nospace 版で重複 emit する挙動、DR-117 §4 文法上正か query 実装 bug か未裁定 |
