...
|---|---|---|---|---|
| 2026-08-02 | bug | open | [dup-raw-command-ordinal-marker-occurrence-gap](./2026-08-02-dup-raw-command-ordinal-marker-occurrence-gap.md) | 同一 raw command を 1 読解で複数回入場した場合、ordinal marker の occurrence 所属が失われる (command_ordinal_at_path の単一候補選択が全 binding を一方へ寄せる) |
