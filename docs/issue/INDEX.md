...
| 2026-07-21 | design | open | [dr113-help-installer-apply-impl-phase-gap](./2026-07-21-dr113-help-installer-apply-impl-phase-gap.md) | DR-113 §1 の help_installer.apply 記述 (内部セル植え付け) と kuu.mbt 実装の暫定位相 (decode-time preset 処理) の差、次回 DR-113 編集時に注記検討 |
| 2026-07-21 | task | open | [dr115-canonical-help-renderer-implementation](./2026-07-21-dr115-canonical-help-renderer-implementation.md) | DR-115 (canonical help レンダラ) の実装完了 — help_render 席・骨格テンプレ・DR-113 §8.1 update 反映 |
