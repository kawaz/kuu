...
|---|---|---|---|---|
| 2026-07-13 | design | idea | [dr101-non-accum-array-only-filter-vocab](./2026-07-13-dr101-non-accum-array-only-filter-vocab.md) | DR-101 §3 判定マトリクスの非 accum × ARRAY-only 綴りの座席が未定 (unknown-vocab vs invalid-range) |
...
| 2026-07-12 | task | open | [complete-query-fixture-coverage-gap](./2026-07-12-complete-query-fixture-coverage-gap.md) | complete クエリの fixture が0件、補完挙動のカバレッジが kuu.mbt wbtest のみ |
