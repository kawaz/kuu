...
|---|---|---|---|---|
| 2026-07-12 | task | open | [wire-schema-missing-env-array-multiple-bool](./2026-07-12-wire-schema-missing-env-array-multiple-bool.md) | wire.schema.json の未対応構文 2 件 (env の配列形 / multiple: true) |
| 2026-07-12 | task | open | [conformance-effect-op-vocab-drift](./2026-07-12-conformance-effect-op-vocab-drift.md) | CONFORMANCE.md §2 の effect op 語彙が実態と乖離 (update/remove/splice 欠落) |
