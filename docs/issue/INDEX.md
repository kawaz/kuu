...
| 2026-08-12 | bug | open | [nested-config-not-supplied](./2026-08-12-nested-config-not-supplied.md) | 参照実装の DR-050 §3 同型対応 nested 未実装 (root の config_file が子スコープの要素へ供給しない) |
