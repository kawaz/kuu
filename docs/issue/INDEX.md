...
|---|---|---|---|---|
| 2026-07-10 | design | idea | [typeless-option-default-semantics](./2026-07-10-typeless-option-default-semantics.md) | option/positional の type 省略時の既定意味論が未規定 (DESIGN §1.3 の省略可宣言と decoder 実装の乖離) |
