...
| 2026-07-17 | design | open | [required-group-scope-participation](./2026-07-17-required-group-scope-participation.md) | 未選択 scope の required/required_group が評価に参加し定義が使用不能になる (scope 参加規則・group label 集約範囲の未規定) |
