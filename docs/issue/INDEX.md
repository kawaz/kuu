...
|---|---|---|---|---|
| 2026-07-12 | idea | open | [short-opt-attach-only-space-form](./2026-07-12-short-opt-attach-only-space-form.md) | short オプションの per-option attach-only 制約 (space-form 拒否) が表現できない |
