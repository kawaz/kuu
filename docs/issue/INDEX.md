...
| 2026-07-11 | task | wip | [dr-090-dd-match-self-implementation](./2026-07-11-dr-090-dd-match-self-implementation.md) | DR-090 を実装完了する: dd installer の match/self 属性対応と corpus 書き直し |
