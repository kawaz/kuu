...
| 2026-07-09 | design | open | [env-failure-argv-pos-convention](./2026-07-09-env-failure-argv-pos-convention.md) | トークン非帰属の失敗 (env/config 由来) の argv_pos 規約が未明文化 |
| 2026-07-09 | design | open | [design-6-2-piece-post-label-collision](./2026-07-09-design-6-2-piece-post-label-collision.md) | DESIGN.md §6.2 pieceProcessor 図の相ラベル「post_filters」が wire フィールド名と衝突 |
| 2026-07-09 | design | open | [ref-template-result-shape](./2026-07-09-ref-template-result-shape.md) | ref テンプレ内要素の結果ビュー形が未確定 (repeat 下の flat 化 / ref 要素自身の露出) |
