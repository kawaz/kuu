...
| 2026-07-14 | design | open | [descriptor-schema-declaration-axis-separation](./2026-07-14-descriptor-schema-declaration-axis-separation.md) | descriptor schema の宣言軸再整理、role/construction/invocation/fallibility の分離。VISION §4 (独自フィルタ可搬性) の中核前提、kuu-core API 整理の次に着手 (codex #3 A-M-1/M-3/M-4) |
...
| 2026-07-14 | design | open | [lowering-generated-element-origin-rule](./2026-07-14-lowering-generated-element-origin-rule.md) | ref/link 越し・lowering 生成要素の complete origin 決定則が未定義 (codex #2 M-14 残 + #3 A-M-9 匿名候補) |
| 2026-07-14 | design | open | [custom-type-candidate-ty-representation](./2026-07-14-custom-type-candidate-ty-representation.md) | custom type 使用時の candidate.ty 表現が未確定 (codex #2 M-13 残) |
| 2026-07-14 | task | open | [cand-completer-followup](./2026-07-14-cand-completer-followup.md) | Cand への completer フィールド実装追随 (DR-104 §2 宣言済みタスク、codex #2 M-5/C-2 残) |
