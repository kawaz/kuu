...
CI green (run 29308411718)。残: M-3 (constraint 系の
positional decode) / M-7 (DR-102 §1 の value_filters 帰属文言の CLI 限定化、
軽微) / scope 境界 fixture (DR-103 §5) / repeat-only + accum_filters 成功側
(minor) / m-1 の spec fixture why 語彙 (multiple 専用 → accum、軽微)。
