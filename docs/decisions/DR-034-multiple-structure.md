# DR-034: multiple の構造モデル (peaceProcessor / separator / accumulator / collector)
...
> **更新: DR-036 により本 DR の collector 独立 registry 構想は廃案。現役では filters registry に統合。本 DR の peaceProcessor/separator/accumulator/collector の4要素構造自体は引き続き有効。**
