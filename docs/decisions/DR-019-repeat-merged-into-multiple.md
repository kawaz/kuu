...
> **更新 (DR-015 / DR-023 と同じ撤回、2026-08-16 に本 DR へも適用): 「seq が単独なら単独」の
> 縮退規定は撤回済み。** `seq` の children 数は 0 個・1 個とも合法で、1 個は単体と等価だが
> **正規化はしない** (DR-067 §2)。同旨の注記は DR-015 / DR-023 に既にあり、本 DR だけ欠けていた。
