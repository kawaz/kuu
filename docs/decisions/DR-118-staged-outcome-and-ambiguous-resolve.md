...
> **更新 (2026-08-16、2 点):**
>
> - **規則 2 (claimants 席) は座席ごと消滅した** — DR-073 の claimants は DR-120 で置き換えられ、
>   露出キーの衝突は definition-error になったので「衝突の provenance を読む席」自体が存在しない
> - **union tie の結果ビューは DR-138 §5 が carve-out を置いた** — DR-130 §4.2 が本 §3 を正本
>   参照するため、tie (同値成功、UC-Q3=a) のときに何が列挙されるかは DR-138 §5 を併せて読む
